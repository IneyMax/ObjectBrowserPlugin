...
struct OBJECTBROWSERPLUGIN_API FObjectDynamicColumn : public TSharedFromThis<FObjectDynamicColumn>
{
	 ...
	 */
	virtual TSharedPtr<SWidget> GenerateColumnWidget(TSharedRef<const ISubsystemTreeItem> Item, TSharedRef<class SObjectBrowserTableItem> TableRow) const = 0;
